...
//for engineer
    ...
    document.querySelector(".result_pants_engineer_line1").innerHTML = Number(engineerLine1) + " " + "հատ";
     document.querySelector(".result_jacket_engineer_line1").innerHTML = Math.floor(engineerLine1/4) + " " + "հատ տղ. համար";
...
let  woman_engineerLine1 = document.querySelector(".input_woman_engineer_line1").value;
   ...
   document.querySelector(".result_pants_woman_engineer_line1").innerHTML = Number(woman_engineerLine1) + " " + "հատ";
    ...
    document.querySelector(".result_jacket_woman_engineer_line1").innerHTML = Math.floor(woman_engineerLine1/4) + " " + "հատ կնոջ համար";
    document.querySelector(".result_shoes_woman_engineer_line1").innerHTML = Math.floor(woman_engineerLine1/3) + " " + "զույգ կնոջ համար";
    document.querySelector(".result_Gloves_line1").innerHTML= (Number(engineerLine1) + Number(woman_engineerLine1))*12;
...
//for the director
    ...
    document.querySelector(".result_jacket_director_line2").innerHTML = Math.floor(directorLine2/4) + " " + "հատ";
    document.querySelector(".result_shoes_director_line2").innerHTML = Math.floor(directorLine2/3) + " " + "զույգ";
    document.querySelector(".result_Gloves_line2").innerHTML = Number(directorLine2*12) + " " + "զույգ";
...
document.querySelector(".general_result_shoes_engineer").innerHTML= (Number(engineerLine1) + Number(woman_engineerLine1) + Number(directorLine2))/3 +" " + " զույգ ճարտ․ համար";

//result jacket


document.querySelector(".general_result_jacket_engineer").innerHTML= Math.floor((Number(engineerLine1) + Number(woman_engineerLine1) + Number(directorLine2)) /4 + (Number(directorLine3)/5)) +" " + " հատ ";

//result gloves

document.querySelector(".general_result_gloves_engineer").innerHTML= Number(engineerLine1*12) + Number(woman_engineerLine1*12) + Number(directorLine2*12) + " " + " զույգ ";
