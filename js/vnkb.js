...
document.querySelector(".general_result_shoes_engineer").innerHTML= Math.floor((Number(engineerLine1) + Number(woman_engineerLine1) + Number(directorLine2))/3) +" " + " զույգ ճարտ․ համար";
...
//for engineer
    ...
    document.querySelector(".result_pants_engineer_line1").innerHTML = engineerLine1 + " " + "հատ";
     document.querySelector(".result_jacket_engineer_line1").innerHTML = Math.floor(engineerLine1/5) + " " + "հատ տղ. համար";
    document.querySelector(".result_shoes_engineer_line1").innerHTML = Math.floor(engineerLine1/3) + " " + "զույգ տղ. համար";
     document.querySelector(".result_Gloves_line1").innerHTML = engineerLine1*6 + " " + "զույգ";
  //for woman engineer  
let  woman_engineerLine1 = document.querySelector(".input_woman_engineer_line1").value;
...
let directorLine3 = document.querySelector(".input_director_line3").value;
   document.querySelector(".result_costume_director_line3").innerHTML = Math.floor(directorLine3/3) + " " + "հատ";
    document.querySelector(".result_jacket_director_line3").innerHTML = Math.floor(directorLine3/5) + " " + "հատ";
    document.querySelector(".result_polo_director_line3").innerHTML = directorLine3*2 + " " + "հատ";
   document.querySelector(".result_pants_director_line3").innerHTML = directorLine3 + " " + "հատ";
