...
//for woman worker
    ...
    document.querySelector(".result_Gloves_line1").innerHTML= (Number(workerLine1) + Number(woman_workerLine1))*12;
     document.querySelector(".result_costume_woman_worker_line1").innerHTML = Number(woman_workerLine1) + " " + "հատ";
...
let engineerLine2 = document.querySelector(".input_engineer_line2").value;
     ...
     document.querySelector(".result_shoes_engineer_line2").innerHTML = Math.floor(engineerLine2/2-0.5) + " " + "զույգ տղ. համար";
     

//for woman engineer

    let  woman_engineerLine2 = document.querySelector(".input_woman_engineer_line2").value;
    document.querySelector(".result_polo_woman_engineer_line2").innerHTML = woman_engineerLine2*2 + " " + "հատ";
    document.querySelector(".result_pants_woman_engineer_line2").innerHTML = woman_engineerLine2 + " " + "հատ";
    ...
    document.querySelector(".result_jacket_woman_engineer_line2").innerHTML = Math.floor(woman_engineerLine2/3) + " " + "հատ կնոջ համար";
     document.querySelector(".result_shoes_woman_engineer_line2").innerHTML = Math.floor(woman_engineerLine2/2) + " " + "զույգ տղ. համար";
    document.querySelector(".result_Gloves_line2").innerHTML= (Number(engineerLine2) + Number(woman_engineerLine2))*12-12;
...
document.querySelector(".general_result_shoes_engineer").innerHTML= Math.floor(engineerLine2/2-0.5)+Math.floor(woman_engineerLine2/2) +" " + " զույգ ճարտ․ համար";

//result jacket

document.querySelector(".general_result_jacket_worker").innerHTML= Math.floor((Number(workerLine1) + Number(woman_workerLine1))/2) + " " + " հատ բանվ.";
...
//result gloves
document.querySelector(".general_result_gloves_worker").innerHTML= Number(workerLine1*12) + Number(woman_workerLine1*12) +  " " + " զույգ բանվ. համ.";
document.querySelector(".general_result_gloves_engineer").innerHTML= Number(engineerLine2*12) + Number(woman_engineerLine2*12)-12 + " " + " զույգ ճարտ. համ.";
...
document.querySelector(".general_result_costume_summer_woman_worker").innerHTML= Math.floor(woman_workerLine1) + " " + " հատ";/////////////////////////////
...
document.querySelector(".general_result_polo_director").innerHTML= (directorLine3*2) + (directorLine4*2)  + " " + " հատ";
...
//for woman worker
    ...
    document.querySelector(".result_jacket_woman_worker_line1").innerHTML = Math.floor(woman_workerLine1/2) + " " + "հատ կնոջ համար";
    document.querySelector(".result_Gloves_line1").innerHTML= (Number(workerLine1) + Number(woman_workerLine1))*12;
     document.querySelector(".result_costume_woman_worker_line1").innerHTML = Number(workerLine1) + " " + "հատ";
