...
//line1
   let workerLine1 = document.querySelector(".input_worker_line1").value;
    ...
    document.querySelector(".result_jacket_worker_line1").innerHTML = Math.floor(Number(workerLine1/2)) + " " + "հատ տղ. համար";
...
let engineerLine2 = document.querySelector(".input_engineer_line2").value;
     ...
     document.querySelector(".result_jacket_engineer_line2").innerHTML = Math.floor(Number(engineerLine2/3)) + " " + "հատ տղ. համար";
...
//for woman engineer
    ...
    document.querySelector(".result_Gloves_line2").innerHTML= (Number(engineerLine2) + Number(woman_engineerLine2))*6;
...
//for the director
    ...
    document.querySelector(".result_jacket_director_line3").innerHTML = Math.floor(directorLine3/4) + " " + "հատ";
    document.querySelector(".result_Gloves_line3").innerHTML= Number(directorLine3)*6;
...
document.querySelector(".general_result_jacket_engineer").innerHTML= Math.floor((Number(engineerLine2) + Number(woman_engineerLine2) + Number(directorLine3)) /4 + (Number(directorLine4)/5)) +" " + " հատ ճարտ. համար ";

//result gloves
document.querySelector(".general_result_gloves_worker").innerHTML= Number(workerLine1*24) +  " " + " զույգ բանվ. համ.";
document.querySelector(".general_result_gloves_engineer").innerHTML= Number(engineerLine2*6) + Number(woman_engineerLine2*6)+ Number(directorLine3*6) + " " + " զույգ ճարտ. համ.";
...
document.querySelector(".general_result_costume_director").innerHTML= Math.floor( (Number(directorLine3) + Number(directorLine4) ) /3) +" " + " հատ ճարտ. համար ";
