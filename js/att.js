...
//for woman engineer
    ...
    document.querySelector(".result_costume_woman_engineer_line2").innerHTML = Math.floor(woman_engineerLine2/3) + " " + "հատ";
...
//for the director
    ...
    document.querySelector(".result_shoes_director_line3").innerHTML = Math.floor(directorLine3/3) + " " + "զույգ տղ. համար";
